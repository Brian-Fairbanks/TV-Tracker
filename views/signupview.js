module.exports = function() {
  ...
  <div class="alert-banner w-full fixed top-0 hidden" id="alert-email">
    <input type="checkbox" class="hidden" id="banneralertemail">
      
    <label class="close cursor-pointer flex items-center justify-between w-full p-2 bg-red-500 shadow text-white" title="close" for="banneralertemail">
  ...
  <div class="alert-banner w-full fixed top-0 hidden" id="alert-password">
    <input type="checkbox" class="hidden" id="banneralertpassword">
      
    <label class="close cursor-pointer flex items-center justify-between w-full p-2 bg-red-500 shadow text-white" title="close" for="banneralertpassword">
      ...
      <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 signup">
        <div class="mb-6">
          ...
          <input
            ...
            id="email-input" type="text" placeholder="This will be your username">
        </div>
        <div>
        ...
        <div class="mb-6">
          <label class="block text-gray-700 text-sm font-bold mb-2" for="password-confrim">
